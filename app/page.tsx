...
export default function Home() {
  ...
  return <main className={count > 0 ? "has-floating-cart" : ""}>
    ...
    <section className="hero"><div className="container hero-grid">
      ...
      <div className="hero-photo"><div className="hero-products"><img src="/products/hero-global-power-blast.webp?v=20260808-3" alt="Global Power Blast"/><img src="/products/hero-chemspec-cotton.png?v=20260808-3" alt="Chemspec Powdered Cotton Upholstery Cleaner"/><img src="/products/hero-global-acid-ocean.webp?v=20260808-3" alt="Global Acid Ocean"/></div><div className="expert-stamp">✓<span>{t.checked}</span></div></div>
    </div></section>
